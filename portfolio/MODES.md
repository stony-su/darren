...
| 3 | **Solar system** | A sun with planets on real elliptical orbits; particles chasing the moving planets smear into visible orbital rings. | The one case where a *moving* target is the point — the smear is the effect. Keep participation low or the rings merge into a disc. |
